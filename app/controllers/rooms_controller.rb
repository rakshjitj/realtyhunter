class RoomsController < ApplicationController
  ...
  def room_update
    ...
    @residential_unit.update(rooms_description: params[:unit_description], rs_only_description: params[:rs_only_description], private_bathroom: params[:private_bathroom], room_syndication: params[:room_syndication], roomfill: params[:roomfill], partial_move_in: params[:partial_move_in], renthop: params[:renthop], working_this_listing: params[:working_this_listing], room_access: params[:room_access], move_in_date: params[:move_in_date], couples_accepted: params[:couples_accepted], tenant_occupied: params[:tenant_occupied], roomshare_department: params[:roomshare_department])
  ...
  def room_image_delete
   ...
   #  end
    def room_params(my_params)
      my_params.permit(:id,:name, :rent, :months_free, :status, :preferences, :bonus, :tenant_pet_info, :room_size, :room_notes, :tenant_info, :renting_agent, :description, :residential_listing_id, :file, :image)
    end
end
