...
left join commercial_listings on units.id = commercial_listings.unit_id')
				...
				listings = listings
					...
					'residential_listings.open_house_mon_from','residential_listings.open_house_mon_to',
					'residential_listings.open_house_tue_from','residential_listings.open_house_tue_to',
					'residential_listings.open_house_wed_from','residential_listings.open_house_wed_to',
					'residential_listings.open_house_thu_from','residential_listings.open_house_thu_to',
